...
const AuthScreen = () => {
    ...
    return (
        <div className='hero-bg relative'>
            ...
            <div className="flex flex-col items-center justify-center text-center text-white py-40 mx-auto max-w-6xl">
                ...
                <form className='flex flex-col md:flex-row gap-4 w-1/2'>
                    <input type="email"
                        ...
                        className='p-2 rounded-lg flex-1 bg-black/60 border border-gray-700'
                        value={email}
                        onChange={(e) => setEmail(e.target.value)}
                    />
                    <button className='bg-red-700 text-xl lg:text-2xl px-2 lg:px-6 py-1 md:py-2 rounded-xl flex justify-center items-center hover:bg-red-600 transition-colors'>Get Started <ChevronRight className='size-8 md:size-10' />
                    </button>
                </form>
            </div>
            ...
            <div className='py-10 bg-black text-white'>
                <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2'>
                        ...
                        <div className='relative'>
                            ...
                            <div className='flex items-center gap-2 absolute bottom-5 left-1/2 -translate-x-1/2 bg-black w-3/4 lg:w-1/2 h-24 border border-slate-500 rounded-md px-2'>
                                ...
                                <div className='flex justify-between items-center w-full'>
                                    ...
                                    <img src="/download-icon.gif" alt="a download gif" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='flex-1 md:text-left text-center'>
                        <h2 className='text-4xl md:text-5xl font-bold mb-4 text-balance'>Download your shows to watch offline</h2>
